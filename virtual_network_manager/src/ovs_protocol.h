...
enum {
  ...
  OVSM_OF_ETH_SRC_W = OVSM_HEADER_W( 0x0000, 2, 6 ),
#endif
  ...
  OVSM_OF_TCP_SRC_W = OVSM_HEADER_W( 0x0000, 9, 2 ),
#endif
  OVSM_OF_TCP_DST = OVSM_HEADER( 0x0000, 10, 2 ),
#if OVS_VERSION_CODE >= OVS_VERSION( 1, 6, 0 )
  OVSM_OF_TCP_DST_W = OVSM_HEADER_W( 0x0000, 10, 2 ),
#endif
  OVSM_OF_UDP_SRC = OVSM_HEADER( 0x0000, 11, 2 ),
#if OVS_VERSION_CODE >= OVS_VERSION( 1, 6, 0 )
  OVSM_OF_UDP_SRC_W = OVSM_HEADER_W( 0x0000, 11, 2 ),
#endif
  OVSM_OF_UDP_DST = OVSM_HEADER( 0x0000, 12, 2 ),
#if OVS_VERSION_CODE >= OVS_VERSION( 1, 6, 0 )
  OVSM_OF_UDP_DST_W = OVSM_HEADER_W( 0x0000, 12, 2 ),
#endif
  ...
  OVSM_OVS_REG5 = OVSM_HEADER( 0x0001, 5, 4 ),
  OVSM_OVS_REG5_W = OVSM_HEADER_W( 0x0001, 5, 4 ),
  OVSM_OVS_REG6 = OVSM_HEADER( 0x0001, 6, 4 ),
  OVSM_OVS_REG6_W = OVSM_HEADER_W( 0x0001, 6, 4 ),
  OVSM_OVS_REG7 = OVSM_HEADER( 0x0001, 7, 4 ),
  OVSM_OVS_REG7_W = OVSM_HEADER_W( 0x0001, 7, 4 ),
#endif
...
#if OVS_VERSION_CODE >= OVS_VERSION( 1, 7, 0 )
  OVSM_OVS_ND_TARGET_W = OVSM_HEADER_W( 0x0001, 23, 16 ),
#endif
  ...
  OVSM_OVS_IPV6_LABEL_W = OVSM_HEADER_W( 0x0001, 27, 4 ),
#endif
  ...
  OVSM_OVS_TUN_IPV4_SRC = OVSM_HEADER  (0x0001, 31, 4),
  OVSM_OVS_TUN_IPV4_SRC_W = OVSM_HEADER_W(0x0001, 31, 4),
  OVSM_OVS_TUN_IPV4_DST = OVSM_HEADER  (0x0001, 32, 4),
  OVSM_OVS_TUN_IPV4_DST_W = OVSM_HEADER_W(0x0001, 32, 4),
  OVSM_OVS_PKT_MARK = OVSM_HEADER  (0x0001, 33, 4),
  OVSM_OVS_PKT_MARK_W = OVSM_HEADER_W(0x0001, 33, 4),
#endif
#if OVS_VERSION_CODE >= OVS_VERSION( 2, 1, 0 )
  OVSM_OVS_TCP_FLAGS = OVSM_HEADER  (0x0001, 34, 2),
  OVSM_OVS_TCP_FLAGS_W = OVSM_HEADER_W(0x0001, 34, 2),
#endif
};
